...
try
{
    ...
    Describe "$($script:DSCResourceName)_Integration" {
        ...
        #region Integration Tests for Disk Location
        Context 'Partition and format newly provisioned disk using Disk Location with two volumes and assign Access Paths' {
            BeforeAll {
                # Create a VHD and attach it to the computer
                $VHDPath = Join-Path -Path $TestDrive `
                    -ChildPath 'TestDisk.vhd'
