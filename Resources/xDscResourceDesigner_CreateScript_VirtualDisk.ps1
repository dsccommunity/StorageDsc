...
$modulename = 'xStorage'
$Description = 'This module is used to create a VirtualDisk on an existing StoragePool. Functionality is limited to create, add a disk to existing, a rename of existing and COMPLETE destroy. It can only filter on disk size and/or numberofdisks'
