...
InModuleScope $script:subModuleName {
    ...
    Describe 'StorageDsc.Common\Test-DscParameterState' -Tag 'Test-DscParameterState' {
    ...
    Describe 'StorageDsc.Common\Get-LocalizedData' -Tag 'Get-LocalizedData' {
        $mockTestPath = {
    ...
    Describe 'StorageDsc.Common\New-InvalidResultException' -Tag 'New-InvalidResultException' {
    ...
    Describe 'StorageDsc.Common\New-ObjectNotFoundException' -Tag 'New-ObjectNotFoundException' {
        Context 'When calling with Message parameter only' {
            It 'Should throw the correct error' {
                $mockErrorMessage = 'Mocked error'
    ...
    Describe 'StorageDsc.Common\New-InvalidOperationException' -Tag 'New-InvalidOperationException' {
        Context 'When calling with Message parameter only' {
            It 'Should throw the correct error' {
                $mockErrorMessage = 'Mocked error'
    ...
    Describe 'StorageDsc.Common\New-NotImplementedException' -Tag 'New-NotImplementedException' {
    ...
    Describe 'StorageDsc.Common\New-InvalidArgumentException' -Tag 'New-InvalidArgumentException' {
