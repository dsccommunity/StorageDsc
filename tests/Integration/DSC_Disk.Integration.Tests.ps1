...
Describe "$($script:dscResourceName)_Integration" {
    ...
    Context 'When partitioning and formatting a newly provisioned disk using Disk Number with two volumes and assigning Drive Letters' {
        ...
        Context 'When creating the first volume' {
        ...
        Context 'When creating the second volume' {
            It 'Should compile and apply the MOF without throwing' {
                {
                    # This is to pass to the Config
                    $configData = @{
        ...
        It 'Should have attached drives' {
            <#
    ...
    Context 'When partitioning and formatting a newly provisioned disk using Disk Number with one volume and assigning Drive Letters then resizing' {
        BeforeAll {
            # Create a VHD and attach it to the computer
            $VHDPath = Join-Path -Path $TestDrive -ChildPath 'TestDisk.vhd'
            $null = New-VDisk -Path $VHDPath -SizeInMB 1024
        ...
        Context 'When creating a volume' {
            It 'Should compile and apply the MOF without throwing' {
                {
                    # This is to pass to the Config
                    $configData = @{
        ...
        Context 'When resizing a partition to use all free space with AllowDestructive' {
            It 'Should compile and apply the MOF without throwing' {
                {
                    # This is to pass to the Config
                    $configData = @{
    ...
    Context 'When partitioning and formatting a newly provisioned disk using Disk Number with one volume using MBR then convert to GPT' {
        ...
        Context 'When clearing Disk and changing the partition style to GPT and adding a 50MB partition' {
            It 'Should compile and apply the MOF without throwing' {
                {
                    # This is to pass to the Config
                    $configData = @{
    ...
    Context 'When partitioning and formatting a newly provisioned disk using FriendlyName with two volumes and assigning Drive Letters' {
        ...
        Context 'When creating the first volume on Disk Friendly Name' {
            It 'Should compile and apply the MOF without throwing' {
                {
                    # This is to pass to the Config
                    $configData = @{
        ...
        Context 'When resizing the first volume on Disk Friendly Name and allowing the disk to be cleared' {
            BeforeAll {
                <#
        ...
        Context 'When creating second volume on Disk Friendly Name' {
            It 'Should compile and apply the MOF without throwing' {
                {
                    # This is to pass to the Config
                    $configData = @{
    ...
    Context 'When partitioning and formatting a newly provisioned disk using Unique Id with two volumes and assigning Drive Letters' {
        ...
        Context 'When creating the first volume on Disk Unique Id' {
            It 'Should compile and apply the MOF without throwing' {
                {
                    # This is to pass to the Config
                    $configData = @{
        ...
        Context 'When resizing the first volume and allowing the disk to be cleared' {
            BeforeAll {
                <#
                    There is an issue with Format-Volume that occurs when formatting a volume
                    with ReFS in Windows Server 2019 (build 17763 and above). Therefore on
        ...
        Context 'When creating second volume on Disk Unique Id' {
            It 'Should compile and apply the MOF without throwing' {
                {
                    # This is to pass to the Config
                    $configData = @{
    ...
    #>
    Context 'When partitioning and formatting a newly provisioned disk using SerialNumber with two volumes and assigning Drive Letters' -Skip:$true {
        BeforeAll {
            # Create a VHD and attach it to the computer
            $VHDPath = Join-Path -Path $TestDrive `
                -ChildPath 'TestDisk.vhd'
        ...
        Context 'When creating the first volume on Disk Serial Number' {
            It 'Should compile and apply the MOF without throwing' {
                {
                    # This is to pass to the Config
                    $configData = @{
        ...
        Context 'When creating second volume' {
            It 'Should compile and apply the MOF without throwing' {
                {
                    # This is to pass to the Config
                    $configData = @{
    ...
    Context 'When partitioning and formatting a newly provisioned disk using Guid with two volumes and assign Drive Letters' {
        BeforeAll {
            # Create a VHD and attach it to the computer
            $VHDPath = Join-Path -Path $TestDrive `
                -ChildPath 'TestDisk.vhd'
    ...
    Context 'When partitioning a disk using Disk Number with a single volume using the whole disk, dismounting the volume then re-provisioning it' {
        BeforeAll {
            # Create a VHD and attach it to the computer
            $VHDPath = Join-Path -Path $TestDrive -ChildPath 'TestDisk.vhd'
            $null = New-VDisk -Path $VHDPath -SizeInMB 1024
        ...
        Context 'When attaching the first volume' {
            BeforeAll {
    ...
    Context 'When maximum size is used, Test-TargetResource needs to report true even though Size and SizeMax are different' {
        ...
        Context 'When using maximum size for new volume' {
            It 'Should compile and apply the MOF without throwing' {
                {
                    # This is to pass to the Config
                    $configData = @{
